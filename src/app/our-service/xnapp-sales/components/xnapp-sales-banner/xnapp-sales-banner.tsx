...
import xnapp_img from "@/app/assets/our-service/xnapp/man-woman-sitting-waiting-room.webp"

export default function XnappSalesBanner() {
  const renderXnappSalesBanner = () => {
    return (
      <div
        className="w-full md:h-160 h-96 bg-cover bg-center "
        style={{ backgroundImage: `url(${xnapp_img.src})` }}
      >
        <div className="relative h-full w-full flex justify-center items-center">
          {/* <div className="absolute bg-white h-auto md:w-160 w-auto md:bottom-36 md:left-10 md:mx-0 mx-2 px-4 py-6 rounded-3xl space-y-4">
            ...
            <p className="md:text-lg sm:text-base text-sm   ">
              ...
              decision making across the first, mid and last mile to deliver
              more at lower costs, and ensure a competitive edge.
            </p>
          </div> */}
        </div>
      </div>

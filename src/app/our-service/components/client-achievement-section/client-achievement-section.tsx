...
export default function ClientAchievementSection() {
  ...
  const renderAchievementCard = () => {
    return (
      <div
        className="bg-cover bg-center lg:h-76 lg:w-76 910px:h-72 910px:w-72 550px:h-64 550px:w-64 h-56 w-56 rounded-3xl overflow-hidden text-white cursor-pointer hover:scale-105 "
